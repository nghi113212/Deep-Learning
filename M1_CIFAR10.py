...
def main():
    ...
    ##################################################################################
    pathout = './checkpoints/CIFAR10_M1_Net/'
    filenameLOG = pathout + '/' + 'FIE02' + '.txt'
    if not os.path.exists(pathout):
        os.makedirs(pathout)
    # get model

    model = M1(num_classes = 10) # thay doi so class cho dung voi dataset, cifar10 co 10 class, cifar100 co 100 class
